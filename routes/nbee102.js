...
router.get('/nbee102_1', commonFunc.checkAuthenticated, async (req, res) => {
    ...
    res.render('nbee102_1.ejs', { Nbee102_QuizMarks, nbee_102_1, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})
...
router.get('/nbee102_2', commonFunc.checkAuthenticated, async (req, res) => {
    ...
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_2.ejs', { Nbee102_QuizMarks, nbee_102_2, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})
...
router.get('/nbee102_3', commonFunc.checkAuthenticated, async (req, res) => {
    ...
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_2.ejs', { Nbee102_QuizMarks, nbee_102_3, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})

router.get('/nbee102_4', commonFunc.checkAuthenticated, async (req, res) => {
    const nbee_102_4 = process.env.Nbee102_3rd_Trimister_05;
    const nbee102 = await Users_Nbee102.find({ email: req.user.email })
    const user = await CertiNbee101.find({ name: req.user.name })
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_2.ejs', { Nbee102_QuizMarks, nbee_102_4, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})

router.get('/nbee102_5', commonFunc.checkAuthenticated, async (req, res) => {
    const nbee_102_5 = process.env.Nbee102_Animea_06;
    const nbee102 = await Users_Nbee102.find({ email: req.user.email })
    const user = await CertiNbee101.find({ name: req.user.name })
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_2.ejs', { Nbee102_QuizMarks, nbee_102_5, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})

router.get('/nbee102_6', commonFunc.checkAuthenticated, async (req, res) => {
    const nbee_102_6 = process.env.Nbee102_Eclampsia_07;
    const nbee102 = await Users_Nbee102.find({ email: req.user.email })
    const user = await CertiNbee101.find({ name: req.user.name })
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_2.ejs', { Nbee102_QuizMarks, nbee_102_6, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})


router.get('/nbee102_7', commonFunc.checkAuthenticated, async (req, res) => {
    const nbee_102_7 = process.env.Nbee102_GDM_08;
    const nbee102 = await Users_Nbee102.find({ email: req.user.email })
    const user = await CertiNbee101.find({ name: req.user.name })
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_2.ejs', { Nbee102_QuizMarks, nbee_102_7, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})


router.get('/nbee102_8', commonFunc.checkAuthenticated, async (req, res) => {
    const nbee_102_8 = process.env.Nbee102_Psychological_Changes_09;
    const nbee102 = await Users_Nbee102.find({ email: req.user.email })
    const user = await CertiNbee101.find({ name: req.user.name })
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_2.ejs', { Nbee102_QuizMarks, nbee_102_8, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})
...
router.get('/nbee102_9', commonFunc.checkAuthenticated, async (req, res) => {
    ...
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_2.ejs', { Nbee102_QuizMarks, nbee_102_9, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})

router.get('/nbee102_quiz1', commonFunc.checkAuthenticated, async (req, res) => {
    const user = await CertiNbee101.find({ name: req.user.name })
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    res.render('nbee102_quiz1.ejs', { Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, phone: req.user.phone, password: req.body.password, email: req.body.email, quiz1_1: req.user.quiz1_1 })
})
...
router.post('/nbee102_quiz2', commonFunc.checkAuthenticated, async (req, res) => {
    ...
    const quiz2mark = Users_Nbee102.findByIdAndUpdate(user_id, req.body, (err, updatedUser) => {
        if (err) {
            console.log(err);
        } else {
...
router.get('/nbee102enrolled', commonFunc.checkNotAuthenticated, async (req, res) => {
    ...
    const EnrolledNbee102 = userNbee.filter(x => x.nbee102_paymentStatus === "true");
