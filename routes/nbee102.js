...
router.get('/nbee102_3', commonFunc.checkAuthenticated, async (req, res) => {
    ...
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_3.ejs', { Nbee102_QuizMarks, nbee_102_3, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})
...
router.get('/nbee102_5', commonFunc.checkAuthenticated, async (req, res) => {
    ...
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_5.ejs', { Nbee102_QuizMarks, nbee_102_5, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})
...
router.get('/nbee102_6', commonFunc.checkAuthenticated, async (req, res) => {
    ...
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_6.ejs', { Nbee102_QuizMarks, nbee_102_6, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})
...
router.get('/nbee102_7', commonFunc.checkAuthenticated, async (req, res) => {
    ...
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_7.ejs', { Nbee102_QuizMarks, nbee_102_7, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})
...
router.get('/nbee102_8', commonFunc.checkAuthenticated, async (req, res) => {
    ...
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_8.ejs', { Nbee102_QuizMarks, nbee_102_8, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})
...
router.get('/nbee102_9', commonFunc.checkAuthenticated, async (req, res) => {
    ...
    let Nbee101_QuizMarks = user[0] === undefined ? null : user[0].quiz2;
    let Nbee102_QuizMarks = user[0] === undefined ? null : nbee102[0].quiz2_nbee102;
    res.render('nbee102_9.ejs', { Nbee102_QuizMarks, nbee_102_9, Nbee101_QuizMarks, paymentStatus: req.user.paymentStatus, name: req.user.name, unvname: req.user.unvname, quiz1_1: req.user.quiz1_1 })
})
